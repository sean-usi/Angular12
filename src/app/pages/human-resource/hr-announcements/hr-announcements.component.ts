...
export class HrAnnouncementsComponent implements OnInit {
  ...
  constructor(private service: BakcEndService, private fb: FormBuilder, private router: Router, private modalService: NgbModal, private profileService: ProfileService, private toastr: ToastrService) { 
